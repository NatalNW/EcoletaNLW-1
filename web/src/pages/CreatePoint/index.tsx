...
const CreatePoint = () => {
    const [items, setItems] = useState<Item[]>([]); // ARRAY OU OBJETO PRECISAMOS INFORMAR O TIPO DA VARIAVEL
    ...
    useEffect(() => {
        ...
        ibge.get<CityResponse[]>(`/${selectedUf}/municipios`).then(res => {
